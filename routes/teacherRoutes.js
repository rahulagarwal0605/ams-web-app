...
router.delete("/courses/:cid/EvalutaionScheme", teacherController.deleteEvaluationSceheme);
router.post("/courses/:cid/EvalutaionScheme", teacherController.setEvaluationSceheme);
router.put("/courses/:cid/EvalutaionScheme", teacherController.editEvaluationSceheme);
